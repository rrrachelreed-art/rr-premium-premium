  ...
  return (
    <section className="space-y-6">
      <header className="space-y-2">
        <h1 className="text-3xl md:text-4xl font-extrabold">Jobs / Recruiting</h1>
        <p className="opacity-80">Post and browse roles. Commission-only brokerage; no licensing implied.</p>
      </header>
